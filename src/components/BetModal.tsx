...
export const BetModal: React.FC<BetModalProps> = ({
  ...
  const checkIsFavorite = React.useCallback((m: Match, favList: { id: number; name: string; country?: string; league?: string }[]) => {
    ...
    // Type casting isTeamNameInFavorites list param since country is optional here but required in data type
    return isTeamNameInFavorites(m.team1, list as any) || isTeamNameInFavorites(m.team2, list as any);
  }, []);
