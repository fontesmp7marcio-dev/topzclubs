                          ...
                          {day.items.map((bet) => {
                            ...
                            return (
                              <div
                                ...
                                className="bg-[#131316] hover:bg-[#18181c] border border-[#24242c] hover:border-zinc-700 p-3 sm:p-3.5 rounded-xl transition-all flex flex-col lg:flex-row lg:items-center justify-between gap-3 group relative cursor-pointer"
                                title="Clique duplo para editar ou excluir esta aposta"
                              >
                                {/* Left Section: Menu, Meta badges, Matchup Pills + Market */}
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 min-w-0 flex-1">
                                  ...
                                  {/* Confrontos em MatchupPill e Mercado */}
                                  <div className="flex items-center gap-2 flex-wrap min-w-0 flex-1">
                                    {bet.legs && bet.legs.length > 0 ? (
                                      bet.legs.map((leg, lIdx) => {
                                        ...
                                        const marketText = null;

                                        return (
                                          <div key={leg.id || lIdx} className="flex items-center gap-1.5 flex-wrap">
                                            <MatchupPill
                                              team1={leg.team1}
                                              team2={leg.team2}
                                              team1Id={leg.team1Id}
                                            ...
                                            {marketText && (
                                              <span className="px-2 py-0.5 rounded bg-[#1d1d25] border border-[#2d2d38] text-zinc-300 text-[11px] font-medium">
                                                {marketText}
                                              </span>
                                            )}

                                            {scoreStr && (
                                              <span className="px-1.5 py-0.5 rounded bg-zinc-800 border border-zinc-700 text-zinc-200 text-[10px] font-black">
                                                {scoreStr}
                                              </span>
                                            )}
                                            ...
                                            <span
                                              ...
                                              title={`Resultado: ${legStatus}`}
                                            />

                                            {lIdx < bet.legs.length - 1 && (
                                        ...
                                        if (parsed) {
                                          return (
                                            <div className="flex items-center gap-2 flex-wrap">
                                              <MatchupPill team1={parsed.team1} team2={parsed.team2} />
                                            </div>
                                          );
                                        }
                                        return (
